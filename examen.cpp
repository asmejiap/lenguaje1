...
int main(int argc, char* argv[]) {	
    ...
    /*
		...
		1 - Actualmente con el password admin puede ingresar al sistema. Cree un segundo password para poder 
		ingresar al sistema. Siempre debe poder ingresar con el password admin y con el nuevo password.
